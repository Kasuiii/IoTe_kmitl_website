            ...
            <div class="round-card round-1">
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="text-lg font-bold">รอบที่ 1 · PORTFOLIO</div>
                    ...
                    @php
                        $round1 = [
                            [
                                ...
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ / อาชีวะ', 'GPAX อย่างน้อย 5 ภาคการศึกษา ≥ 3.50', 'เคยได้รับรางวัลการแข่งขันระดับชาติหรือนานาชาติ ด้านคณิตศาสตร์–วิทยาศาสตร์–เทคโนโลยี อย่างน้อย 1 รายการ', 'ไม่มีโรคสำคัญที่เป็นอุปสรรคต่อการศึกษา'],
                            ],
                            [
                                'name' => 'โครงการเรียนดี ช้างเผือก (สายสามัญ)',
                                'seats' => '30 คน (รับร่วมกัน)',
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ', 'โรงเรียนเสนอชื่อนักเรียน GPAX สูงสุดอย่างน้อย 5 ภาคการศึกษา (ม.4–6)'],
                            ],
                            [
                                'name' => 'โครงการรางวัลและประกาศนียบัตรทางวิชาการ',
                                'seats' => '30 คน (รับร่วมกัน)',
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ', 'GPAX อย่างน้อย 5 ภาคการศึกษา ≥ 3.00', 'มีผลงาน รางวัล หรือประกาศนียบัตร'],
                            ],
                            [
                                'name' => 'โครงการโรงเรียนวิทยาศาสตร์',
                                'seats' => '30 คน (รับร่วมกัน)',
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ', 'GPAX อย่างน้อย 5 ภาคการศึกษา ≥ 3.00', 'กำลังศึกษา ม.6 สาย วิทย์–คณิต ในโรงเรียนวิทยาศาสตร์ หรือห้องเรียนพิเศษวิทยาศาสตร์–คณิตศาสตร์'],
                            ],
                            [
                                'name' => 'โครงการ Engineering Pathway',
                                'seats' => '30 คน (รับร่วมกัน)',
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ / อาชีวะ', 'เคยเข้าร่วมโครงการ Pre-Engineering School ของคณะวิศวกรรมศาสตร์ สจล.', 'คะแนนเฉลี่ยสะสมจาก 6 วิชา ≥ 3.5'],
                            ],
                            [
                                'name' => 'โครงการ สอวน. (มูลนิธิโอลิมปิกวิชาการ)',
                                'seats' => '40 คน (รวมทุกหลักสูตร)',
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ', 'กำลังศึกษาหรือสำเร็จการศึกษา ม.6 สาย วิทย์–คณิต / ศิลป์–คำนวณ', 'GPAX อย่างน้อย 4 ภาคการศึกษา ≥ 2.75', 'ผ่านการอบรมค่าย 2 ของมูลนิธิ สอวน.'],
                            ],
                            [
                                'name' => 'โครงการบุตรของบุคลากร สจล.',
                                'seats' => '5 คน (รวมทุกหลักสูตร)',
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ', 'กำลังศึกษา ม.6 สาย วิทย์–คณิต', 'GPAX อย่างน้อย 5 ภาคการศึกษา ≥ 2.75', 'เป็นบุตรโดยชอบด้วยกฎหมายของพนักงาน/ข้าราชการ/ลูกจ้างประจำของ สจล. เท่านั้น'],
                            ],
                        ];
                    @endphp
                        ...
                        <div class="project-item">
                            <div class="project-header" onclick="this.closest('.project-item').classList.toggle('open')">
                                <div class="flex min-w-0 items-center gap-3">
                                    ...
                                    <span class="truncate text-sm font-semibold" style="color: var(--dark)">{{ $project['name'] }}</span>
                                </div>
                                <span class="seats-badge shrink-0">{{ $project['seats'] }}</span>
                            </div>
            ...
            <div class="round-card round-2">
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="text-lg font-bold">รอบที่ 2 · QUOTA</div>
                    ...
                    @php
                        $round2 = [
                            [
                                ...
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ / อาชีวะ', 'GPAX อย่างน้อย 5 ภาคการศึกษา ≥ 3.00'],
                            ],
                            [
                                'name' => 'โควตากิจกรรม K-Engineering',
                                'seats' => '15 คน (รับร่วมกัน)',
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ / อาชีวะ', 'GPAX อย่างน้อย 5 ภาคการศึกษา ≥ 2.75', 'ผ่านการเข้าร่วมกิจกรรมและได้รับประกาศนียบัตรในโครงการทางวิชาการกับคณะวิศวกรรมศาสตร์ สจล.'],
                            ],
                            [
                                'name' => 'โควตา KMITL One',
                                'seats' => '15 คน (รับร่วมกัน)',
                                'reqs' => ['รับจากหลักสูตรแกนกลาง / นานาชาติ / อาชีวะ', 'GPAX 5 ภาคการศึกษา > 3.00 (หรือ > 2.75 สำหรับผู้สมัครโครงการ K-Engineering)'],
                            ],
                        ];
                    @endphp
                    ...
                    @foreach ($round2 as $project)
                        <div class="project-item">
                            <div class="project-header" onclick="this.closest('.project-item').classList.toggle('open')">
                                ...
                                <span class="seats-badge shrink-0" style="background: var(--orange)">{{ $project['seats'] }}</span>
                            </div>
                            <div class="project-body">
                                <p class="mb-2 text-xs font-semibold tracking-wider uppercase" style="color: var(--orange)">
                                    คุณสมบัติผู้สมัคร
            ...
            <div class="round-card round-3">
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <div class="text-lg font-bold">รอบที่ 3 · ADMISSION</div>
                ...
                <div class="round-body">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            <h4 class="mb-3 font-bold" style="color: var(--dark)">คุณสมบัติ</h4>
                            ...
                            <div class="rounded-10 mt-4 p-3" style="background: rgba(114, 10, 0, 0.06); border-radius: 10px">
                                <span class="text-sm font-semibold" style="color: var(--crimson)">จำนวนที่เปิดรับ:</span>
                                <span class="ml-2 text-sm" style="color: var(--dark)">5 คน</span>
                            </div>
                        </div>
                        <div>
                            <h4 class="mb-3 font-bold" style="color: var(--dark)">การคำนวณคะแนน</h4>
                            <div class="space-y-2">
                                @foreach ([
                                    ...
                                    <div class="score-row">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-bold" style="color: var(--crimson); width: 32px; text-align: right">
                                                {{ $score['pct'] }}%
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <a
                                href="https://new.reg.kmitl.ac.th/admission/#/"
                                target="_blank"
                                class="btn-primary mt-4 inline-flex items-center gap-2 text-sm"
                            >
                                สมัครผ่านระบบ KMITL
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path
