...
@push('styles')
    <style>
        ...
        .program-card:hover {
            box-shadow: 0 20px 50px rgba(114, 10, 0, 0.12);
        ...
        .project-card:hover {
            box-shadow: 0 16px 40px rgba(114, 10, 0, 0.12);
        ...
        .career-tag {
            ...
            color: var(--crimson);
            border: 1px solid rgba(114, 10, 0, 0.15);
            transition: all 0.2s;
        }
        .career-tag:hover {
            background: var(--crimson);
...
@section('content')
        ...
        <div class="hero-slide active">
            ...
            <div class="hero-content">
                ...
                <h1>
                    Department of
                    <br />
                    <em style="color: #ffaa77">IoT and Information</em>
                    <br />
                    Engineering
                </h1>
    ...
    <section style="background: var(--dark); padding: 4rem 0">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 gap-6 md:grid-cols-4">
                ...
                <div class="stat-card">
                    <div class="mb-1 text-4xl font-black" style="font-family: 'Playfair Display', serif">17+</div>
                    <div class="text-sm font-medium opacity-80">Expert Faculty</div>
                </div>
                <div class="stat-card">
                    <div class="mb-1 text-4xl font-black" style="font-family: 'Playfair Display', serif">4</div>
                    <div class="text-sm font-medium opacity-80">Degree Programmes</div>
                </div>
                <div class="stat-card">
                    <div class="mb-1 text-4xl font-black" style="font-family: 'Playfair Display', serif">50+</div>
                    <div class="text-sm font-medium opacity-80">Years of Excellence Engineering at kmitl</div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
                <div>
                    ...
                    <h2 class="section-title">
                        IoT System &
                        <br />
                        <em style="color: var(--crimson)">Information Engineering</em>
                    </h2>
                    <div class="accent-line mt-4 mb-6"></div>
                    <p class="mb-5 leading-relaxed" style="color: var(--muted); font-size: 1.05rem">
                        ในโลกยุคดิจิทัล 4.0 ที่เทคโนโลยีต่าง ๆ เข้ามามีบทบาทสำคัญในชีวิตประจำวัน
                        หลักสูตรวิศวกรรมระบบไอโอทีและสารสนเทศผลิตวิศวกรที่สามารถออกแบบสร้างนวัตกรรมด้านระบบ IoT และสารสนเทศได้อย่างครบวงจร
                    </p>
                    <p class="mb-8 leading-relaxed" style="color: var(--muted)">
                        หลักสูตรนี้ตอบสนองนโยบายพัฒนาเศรษฐกิจแห่งชาติฉบับที่ 13 (พ.ศ. 2565–2569) รองรับอุตสาหกรรม S-Curve
                        ทั้งอิเล็กทรอนิกส์อัจฉริยะ ดิจิทัล และการพัฒนาเขต EEC
                    </p>
                    {{--
                        <div class="mb-8 grid grid-cols-2 gap-4">
                        @foreach ([
                        ['💻', 'Software & Hardware', 'การพัฒนาซอฟต์แวร์และอุปกรณ์อิเล็กทรอนิกส์เพื่อใช้งานประยุกต์ต่อยอด'],
                        ['📡', 'Communication & Network', 'ระบบสื่อสารและ เครือข่าย'],
                        ['🤖', 'AI & Machine Learning', 'ปัญญาประดิษฐ์ '],
                        ['🔒', 'Cybersecurity', 'ความมั่นคงสารสนเทศ และการป้องกันระบบ']
                        ]
                        as [$icon, $title, $desc])
                        <div class="rounded-xl p-4" style="background: #fff; border: 1px solid var(--border)">
                        <div class="mb-2 text-2xl">{{ $icon }}</div>
                        <div class="mb-1 text-sm font-semibold" style="color: var(--dark)">{{ $title }}</div>
                    ...
                    <div class="flex flex-1 flex-col p-6">
                        ...
                        <div class="mt-auto border-t pt-4" style="border-color: var(--border)">
                            <div class="flex justify-between text-sm">
                                ...
                                <span style="color: var(--muted)">
                                    Tuition:
                                    <strong style="color: var(--crimson)">25,000 ฿/sem</strong>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="program-card">
                    <div class="program-card-top" style="background: linear-gradient(135deg, #1a1a2e, #720a00)">
                        ...
                        <h3
                            ...
                            "
                        >
                            B.Eng. IoT + B.Sc. Industrial Physics
                        </h3>
                ...
                <div class="program-card">
                    <div class="program-card-top" style="background: linear-gradient(135deg, var(--orange), #c44a00)">
                        ...
                        <div
                            ...
                            "
                        >
                            Continuing Programme · ต่อเนื่อง
                        </div>
                        <h3
                            style="
                                font-family: 'Playfair Display', serif;
                            ...
                            "
                        >
                            B.Eng. Computer and IoT Engineering
                        </h3>
                ...
                <div class="program-card">
                    <div class="program-card-top" style="background: linear-gradient(135deg, #2d1b4e, #720a00)">
                        ...
                        <h3
                            ...
                            "
                        >
                            M.Eng. &amp; Ph.D. — AIoT and Information
                        </h3>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                @foreach ($projects as $p)
                    <a href="{{ $p['url'] }}" target="_blank" class="project-card" style="text-decoration: none; color: inherit">
                        ...
                        <div class="p-5">
                            <span class="tag" style="font-size: 0.7rem; margin-bottom: 0.75rem; display: inline-block">
                                {{ $p['tag'] }}
                            </span>
                            <h3
                                class="mb-2 leading-tight font-bold"
                                style="font-family: 'Playfair Display', serif; color: var(--dark); font-size: 1rem"
                            >
                                {{ $p['title'] }}
                            </h3>
            ...
            <div class="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
                <div>
                    ...
                    <h2 class="section-title">
                        Career
                        <br />
                        <em style="color: var(--crimson)">Opportunities</em>
                    </h2>
                    <div class="accent-line mt-4 mb-6"></div>
                    <p class="mb-8 leading-relaxed" style="color: var(--muted)">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                @php
                    $highlights = [
                        ...
                        ['🔬', 'Our Laboratory', 'ห้องปฏิบัติการชั้นนำ ที่หลากหลายของภาควิชา มีงานวิจัยระดับแนวหน้าที่ได้รับการยอมรับ พร้อมนักวิจัยเชี่ยวชาญ'],
                ...
                @foreach ($highlights as [$icon, $title, $desc])
                    <div
                        ...
                        style="border: 1px solid var(--border); transition: all 0.3s"
                        onmouseover="
                            this.style.boxShadow = '0 16px 40px rgba(114,10,0,0.1)';
                    ...
                    >
                        ...
                        <h3 class="mb-3 text-lg font-bold" style="font-family: 'Playfair Display', serif; color: var(--dark)">
                            {{ $title }}
                        </h3>
    ...
    <!-- ═══ CTA BANNER ═══ -->
    <section
        style="background: linear-gradient(135deg, var(--crimson), var(--orange)); padding: 5rem 0; position: relative; overflow: hidden"
    >
        <div
            style="
                position: absolute;
        ...
        <div class="mx-auto max-w-4xl px-4 text-center" style="position: relative; z-index: 1">
            ...
            <p style="color: rgba(255, 255, 255, 0.85); font-size: 1.125rem; max-width: 600px; margin: 0 auto 0.75rem">
                วศ.บ. วิศวกรรมระบบไอโอทีและสารสนเทศ · 95 ที่นั่ง
            </p>
            ...
            <div class="flex flex-wrap justify-center gap-4">
                ...
                <a
                    href="http://admission.reg.kmitl.ac.th/"
                    target="_blank"
                    style="
