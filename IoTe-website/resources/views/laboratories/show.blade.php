...
@section('content')
    ...
    <section class="lab-hero-show" style="background: var(--dark)">
        ...
        <div class="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto" style="position: relative; z-index: 1">
            <!-- Breadcrumb -->
            <nav class="mb-6 gap-2 text-sm flex items-center" style="color: rgba(255, 255, 255, 0.55)">
            ...
            <div class="mb-4 gap-4 flex items-center">
                <div
                    class="h-14 w-14 rounded-xl text-xl font-black flex shrink-0 items-center justify-center"
    ...
    <div style="background: #fff; border-bottom: 1px solid var(--border); position: sticky; top: 64px; z-index: 40">
        <div class="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="gap-2 py-3 flex overflow-x-auto">
    ...
    <!-- TAB CONTENTS -->
    <div class="max-w-7xl px-4 py-12 sm:px-6 lg:px-8 mx-auto">
        <!-- OVERVIEW -->
        <div class="tab-content active" id="tab-overview">
            <div class="gap-10 lg:grid-cols-3 grid grid-cols-1">
            ...
            <div class="gap-6 md:grid-cols-4 grid grid-cols-2">
                @foreach ($lab['team'] as $member)
                    <div class="text-center">
                        <div
                            class="mb-3 h-20 w-20 mx-auto overflow-hidden rounded-full"
                            style="background: var(--light); border: 3px solid var(--border)"
                        >
                            <div class="text-2xl flex h-full w-full items-center justify-center">{{ $member['avatar'] }}</div>
                        </div>
    ...
    <!-- BACK LINK -->
    <div class="max-w-7xl px-4 pb-16 sm:px-6 lg:px-8 mx-auto">
        <a
            href="{{ route('laboratories.index') }}"
            class="gap-2 text-sm font-medium inline-flex items-center"
